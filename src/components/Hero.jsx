  ...
  return (
    <section id="inicio" className="hero-v6">
      ...
      <div className="felipe-layer-v6 reveal">
        <video src="/felipe.mp4" autoPlay loop muted playsInline className="felipe-video-v6" />
      ...
      <div className="container" style={{ position: 'relative', zIndex: 20 }}>
        <div className="hero-content-v6">
          ...
          <p className="hero-p-v6 reveal" style={{ transitionDelay: '0.3s' }}>
            Acompañamiento integral, Estructura Corporativa optimizada, Estrategia y Plan de Expansión personalizado para empresarios que facturan +$15K/mes. Sin errores y con resultados reales.
          </p>
